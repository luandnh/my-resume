...
function WorkExperience($$payload) {
  ...
  $$payload.out += `<article class="timeline__item"><h3 class="title title--h3 timeline__title">TEL4VN</h3> <span class="timeline__period">2020 — 02/2025</span> <div class="timeline__description mb-2"><span class="fw-bold">TEL4VN</span> is a leading company specializing in telecommunications solutions
